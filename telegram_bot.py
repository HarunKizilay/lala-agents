...
def cmd_durum(chat_id: int, _args: str):
    send(chat_id,
         ...
         "*Nasıl kullanılır:*\n"
         "Ne istediğinizi Türkçe yazın — sistem otomatik yönlendirir.\n\n"
         "*Örnekler:*\n"
         ...
         "✅ Uygula — dosyalara yazar\n"
         "✅ Uygula \\+ Push — yazar \\+ GitHub \\+ DO deploy\n"
         "✏️ Revize Et — ajanla düzeltme iste\n"
         "❌ İptal\n\n"
         "*Sistem komutları:*\n"
         "`/setenv ANAHTAR=değer` — .env güncelle\n"
         "`/deploy-setup` — DO otomatik deploy kur \\(bir kez\\)\n"
         "`/iptal` — Bekleyen işlemi iptal et\n"
